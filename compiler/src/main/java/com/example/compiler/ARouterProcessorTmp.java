...
public class ARouterProcessorTmp extends AbstractProcessor {
    ...
    public boolean process(Set<? extends TypeElement> set, RoundEnvironment roundEnvironment) {
        ...
        // 获取所有带ARouter注解的 类节点
        Set<? extends Element> elements = roundEnvironment.getElementsAnnotatedWith(ARouterTmp.class);
        // 遍历所有类节点
        for (Element element : elements) {
            ...
            try {
                ...
                ARouterTmp aRouter = element.getAnnotation(ARouterTmp.class);
